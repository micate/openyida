...
const { assertAppCreationAllowed } = require('./app-capabilities');
...
async function run(args) {
  ...
  // Fail before any resource mutation. The server-side check is read-only and
  // shares the same authorization and quota predicates as registerApp.
  await assertAppCreationAllowed(authRef);
